...
] #end here for lnguage translate
...
LANGUAGE_CODE = 'en'  #for language switching to work seamlessly.
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'dinumishra725@gmail.com'
EMAIL_HOST_PASSWORD = 'gyhp rugk kihb with'
